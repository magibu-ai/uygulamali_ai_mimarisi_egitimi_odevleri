...
DATA_FILE = os.path.join(os.path.dirname(__file__), "..", "data", "ilceler.txt")
BATCH_SIZE = 64
...
tokenizer = BPETokenizer.from_file(DATA_FILE,vocab_size=300)
...
torch.save({"model": model.state_dict(), "merges": tokenizer.merges, "cfg": cfg},
           "tiny_qwen.pt")
